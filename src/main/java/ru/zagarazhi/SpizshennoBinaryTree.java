...
// честно спиздил, вроде бы даже работает

import java.util.*;

public class SpizshennoBinaryTree {
    int m;
    InternalNode root;
    LeafNode firstLeaf;
    ...
    public SpizshennoBinaryTree(int m) {
        this.m = m;
        this.root = null;
    }
    ...
    public static void main(String[] args) {
        SpizshennoBinaryTree bpt = null;
        bpt = new SpizshennoBinaryTree(3);
        bpt.insert(5, 33);
        bpt.insert(15, 21);
        bpt.insert(25, 31);
        bpt.insert(35, 41);
